...
const int maxA5 = 14;
const int maxW5 = 1200;		//	最大负重
const int maxD5 = 10;		//	最大天数
const int basicM5 = 200;	//	基础收益
const int initM5 = 10000;	//	初始资金
goods _water5(0, 3, 5, 3, 9, 10);		// 水的质量，金额，对应天气消耗的量
goods _food5(1, 2, 10, 4, 9, 10);		// 食物的质量，金额，对应天气消耗的量
